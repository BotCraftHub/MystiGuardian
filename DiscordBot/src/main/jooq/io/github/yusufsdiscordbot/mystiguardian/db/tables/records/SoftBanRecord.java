...
import io.github.yusufsdiscordbot.mystiguardian.db.tables.pojos.SoftBan;
...
public class SoftBanRecord extends UpdatableRecordImpl<SoftBanRecord> implements Record6<String, String, String, Integer, Long, OffsetDateTime> {
    ...
    public Field<String> field1() {
        return io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN.REASON;
    }

    @Override
    public Field<String> field2() {
        return io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN.USER_ID;
    }

    @Override
    public Field<String> field3() {
        return io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN.GUILD_ID;
    }

    @Override
    public Field<Integer> field4() {
        return io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN.DAYS;
    }

    @Override
    public Field<Long> field5() {
        return io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN.ID;
    }

    @Override
    public Field<OffsetDateTime> field6() {
        return io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN.TIME;
    }
    ...
    public SoftBanRecord() {
        super(io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN);
    }
     ...
     * Create a detached, initialised SoftBanRecord
     */
    public SoftBanRecord(SoftBan value) {
        super(io.github.yusufsdiscordbot.mystiguardian.db.tables.SoftBan.SOFT_BAN);
