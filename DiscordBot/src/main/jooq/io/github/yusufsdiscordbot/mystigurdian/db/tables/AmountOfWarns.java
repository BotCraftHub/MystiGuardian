...
public class AmountOfWarns extends TableImpl<AmountOfWarnsRecord> {
     ...
     */
    public final TableField<AmountOfWarnsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public UniqueKey<AmountOfWarnsRecord> getPrimaryKey() {
        return Keys.PK_AMOUNT_OF_WARNS;
    }

    @Override
    public List<UniqueKey<AmountOfWarnsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UK_AMOUNT_OF_WARNS);
    }
