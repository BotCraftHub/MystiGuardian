...
public class ButtonClickHandler {
    ...
    private void handleButtonClick() {
        String customId = buttonClickEvent.getId();
        ...
        if (customId.startsWith("prev_") || customId.startsWith("next_")) {
            ...
            buttonClickEvent
                    .reply("Loading...")
                    .setEphemeral(true)
                    .queue(null, throwable -> MystiGuardianUtils.logger.error("Failed to acknowledge button interaction", throwable));
        }
        ...
        if (customId.equals("delete")) {
            buttonClickEvent
                    .getMessage()
                    .delete()
                    .queue(null, throwable -> MystiGuardianUtils.logger.error("Failed to delete message", throwable));
        }
    }
