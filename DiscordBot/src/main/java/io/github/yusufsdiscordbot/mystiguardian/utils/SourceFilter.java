...
public class SourceFilter {
    ...
    public static JsonNode filterBySource(
            JsonNode results, Set<String> excludedSources, ObjectMapper objectMapper) {
        ...
        for (JsonNode result : results.path("organic_results")) {
            ...
            if (excludedSources.stream().noneMatch(link::contains)) {
