 ...
 *   <li>REST API endpoints for web dashboard integration</li>
 *   <li>User and guild information retrieval</li>
 * </ul>
 *
 * <p>The service runs on Spark Java framework and automatically finds an available
 * port in the range 25590-25600. It handles:
 * <ul>
 *   <li>OAuth callback processing</li>
 *   <li>Token exchange with Discord</li>
 *   <li>Secure JWT generation for session management</li>
 *   <li>CORS configuration for web dashboard</li>
 * </ul>
 *
 * <p><b>Configuration:</b> OAuth credentials are loaded from config.json under
 * the "discordAuth" section:
 * <pre>
 * {
 *   "discordAuth": {
 ...
 * </pre>
 *
 * <p><b>Security:</b> JWT tokens are used for securing API endpoints. The secret
 * is automatically generated or loaded from configuration.
 *
 * @see JWTUtils
 * @see DiscordRestAPI
...
public class OAuth {
     ...
     * <p>This method:
     * <ul>
     *   <li>Initializes JWT utilities</li>
     *   <li>Loads OAuth credentials from configuration</li>
     *   <li>Creates Discord REST API client</li>
     *   <li>Finds an available port (25590-25600)</li>
     *   <li>Starts Spark web server</li>
     *   <li>Registers all HTTP request handlers</li>
     * </ul>
     *
     * <p>The service runs on a separate thread and continues running until
