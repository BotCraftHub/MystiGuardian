 ...
 *
 * <p>This record parses and provides access to OAuth token data including access tokens, refresh
 * tokens, and token metadata. Records automatically generate a canonical constructor.
 *
