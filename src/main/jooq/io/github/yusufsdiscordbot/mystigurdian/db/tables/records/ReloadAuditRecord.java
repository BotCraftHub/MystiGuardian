...
public class ReloadAuditRecord extends TableRecordImpl<ReloadAuditRecord> implements Record3<String, String, Long> {
    ...
    @Override
    public ReloadAuditRecord values(String value1, String value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public ReloadAuditRecord(String reason, String userId, Long id) {
        super(ReloadAudit.RELOAD_AUDIT);
