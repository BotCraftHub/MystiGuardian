...
public class PingCommand implements ISlashCommand {
    ...
    public void onSlashCommandInteractionEvent(SlashCommandInteraction event) {
        ...
        val gatewayLatency = MystiGurdianUtils.formatUptimeDuration(unFormattedGatewayLatency);
        val restLatency = MystiGurdianUtils.formatUptimeDuration(unFormattedRestLatency);
