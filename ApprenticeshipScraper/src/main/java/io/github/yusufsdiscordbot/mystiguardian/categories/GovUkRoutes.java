 ...
 *
 * <p>Routes map human-readable category names to their GOV.UK route IDs.
 * These IDs are used in search URLs to filter apprenticeships by sector.
 *
 * <p>Available routes:
 * <ul>
 *   <li>Agriculture, environmental and animal care (ID: 1)</li>
 *   <li>Business and administration (ID: 2)</li>
 *   <li>Care services (ID: 3)</li>
 *   <li>Catering and hospitality (ID: 4)</li>
 *   <li>Construction and the built environment (ID: 5)</li>
 *   <li>Creative and design (ID: 6)</li>
 *   <li>Digital (ID: 7)</li>
 *   <li>Education and early years (ID: 8)</li>
 *   <li>Engineering and manufacturing (ID: 9)</li>
 *   <li>Hair and beauty (ID: 10)</li>
 *   <li>Health and science (ID: 11)</li>
 *   <li>Legal, finance and accounting (ID: 12)</li>
 *   <li>Protective services (ID: 13)</li>
 *   <li>Sales, marketing and procurement (ID: 14)</li>
 *   <li>Transport and logistics (ID: 15)</li>
 * </ul>
 *
