...
public final class HigherinCategories {
    ...
    public static final List<String> TECHNOLOGY = List.of(
            "computer-science",
            "cyber-security",
            "data-analysis",
    ...
    public static final List<String> ENGINEERING = List.of(
    ...
    public static final List<String> MARKETING = List.of(
            "advertising",
            "digital-marketing",
            "marketing",
    ...
    public static final List<String> DESIGN = List.of(
            "architecture",
            "fashion-design",
            "graphic-design",
            "product-design",
    ...
    public static final List<String> LEGAL = List.of(
            "commercial-law",
            "corporate-law",
            "employment-law",
    ...
    public static final List<String> CONSTRUCTION = List.of(
            "construction",
    ...
    public static final List<String> RETAIL = List.of(
    ...
    public static final List<String> HOSPITALITY = List.of(
    ...
    public static final List<String> HR = List.of(
            "human-resources",
            "recruitment"
    );
    ...
    public static final List<String> PUBLIC_SECTOR = List.of(
            "teaching",
            "government",
            "social-work",
            "armed-forces",
    ...
    public static final List<String> SCIENCE = List.of(
            "chemistry",
